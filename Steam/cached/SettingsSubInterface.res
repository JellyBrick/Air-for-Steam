"steam/cached/SettingsSubInterface.res"
{
	layout {
		...
		place { control=Label1					dir=down start=Divider1 y=10 }
		...
		place { control=Label3					dir=down start=Divider3 y=10 }
		...
		place [$LINUX||$OSX] { control=Divider2			dir=down width=max start=UrlBarCheck y=10 }
		place [$WINDOWS] { control=Divider2			dir=down width=max start=H264HWAccelCheck y=10 }

		place { control=NotifyAvailableGamesCheck		dir=down start=Divider2 y=10 }
